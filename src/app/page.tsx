...
export default function PaginaInicial() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-amber-100">
      <div className="bg-gray-50 p-8 rounded-lg shadow-lg text-center">
        ...
        <form onSubmit={lidarComEnvio} className="flex flex-col gap-4">
          ...
          />
          <p className="text-l italic text-gray-600 mb-2">
            Se o famoso for pouco conhecido, coloque uma forma de identificação, como o nome completo ou trabalho mais conhecido.
          </p>
          <button
            type="submit"
